...
def inception_block_1a(X):
    ...
    # MaxPooling branch followed by 1x1 Convolution
    X_pool = MaxPooling2D(pool_size=3, strides=1, padding='same', data_format='channels_first')(X)
...
def inception_block_1b(X):
    ...
    # AveragePooling branch followed by 1x1 Convolution
...
def inception_block_2a(X):
    ...
    X_pool = fr_utils.conv2d_bn(X_pool,
                           ...
                           cv1_out=128,
                           cv1_filter=(1, 1),
                           padding=(0, 0))  # No padding here, as AveragePooling output will be 10x10
...
def inception_block_3a(X):
    ...
    X_pool = fr_utils.conv2d_bn(X_pool,
                           ...
                           cv1_out=96,
                           cv1_filter=(1, 1),
                           padding=(0, 0))  # No extra padding, as the pooling layer maintains dimensions
    X_1x1 = fr_utils.conv2d_bn(X,
...
def inception_block_3b(X):
    ...
    X_3x3 = BatchNormalization(axis=1)(X_3x3)
    X_3x3 = Activation('relu')(X_3x3)
    X_3x3 = Conv2D(384, (3, 3), strides=(1, 1), padding='same')(X_3x3)
    X_3x3 = BatchNormalization(axis=1)(X_3x3)
    X_3x3 = Activation('relu')(X_3x3)

    # Branch 2: MaxPooling followed by 1x1 Convolution
    X_pool = MaxPooling2D(pool_size=(3, 3), strides=1, padding='same')(X)
    X_pool = Conv2D(96, (1, 1), padding='same')(X_pool)
    X_pool = BatchNormalization(axis=1)(X_pool)
    X_pool = Activation('relu')(X_pool)

    # Branch 3: 1x1 Convolution
    X_1x1 = Conv2D(256, (1, 1), strides=(1, 1), padding='same')(X)
    X_1x1 = BatchNormalization(axis=1)(X_1x1)
    X_1x1 = Activation('relu')(X_1x1)
